...
const KIND_CONFIG: Record<TxKind, TxKindConfig> = {
  ...
  transfer_in: { iconName: 'arrow-down', label: 'Transfer in', className: 'bg-info/[0.14] text-info', sign: '+' },
  transfer_out: { iconName: 'arrow-up', label: 'Transfer out', className: 'bg-info/[0.14] text-info', sign: '-' },
